...
def _(mo):
    mo.md(
        r"""
        ## 16 · Pothole and curb — the road UC and VoP can't handle (Ch 9 prototype)

        Same chassis as Demo 15:
        $y'' + 2\gamma\,y' + \omega_0^2\,y = \omega_0^2\,g(t)$. What
        changes is the road. Three buttons let you switch between
